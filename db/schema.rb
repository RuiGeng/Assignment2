...
ActiveRecord::Schema.define(version: 20160319021612) do
  ...
  create_table "pizzas", force: :cascade do |t|
    ...
    t.decimal  "type_price",                 precision: 5,  scale: 2, default: 0.0, null: false
    t.string   "pizza_size",     limit: 255,                          default: "",  null: false
    t.decimal  "size_price",                 precision: 5,  scale: 2, default: 0.0, null: false
    t.string   "toppings",       limit: 255,                          default: "",  null: false
    t.decimal  "toppings_price",             precision: 5,  scale: 2, default: 0.0, null: false
    t.string   "crust",          limit: 255,                          default: "",  null: false
    t.decimal  "crust_price",                precision: 5,  scale: 2, default: 0.0, null: false
